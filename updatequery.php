...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
			...
			<form name="f1" method="post" action="updatequerys.php">
			<div class="row">
			<div class="col-lg-2">
			...
			<div class="row">
			<div class="col-lg-4">
			<input type="text" name="fldnm" id="fldnm" placeholder="Unique Field Name" class="form-control">
			</div>
			<div class="col-lg-4">
			<input type="text" name="varnm" id="varnm" placeholder="Variable Name" class="form-control">
			</div>
			</div><br>
			<div class="row">
			<div class="col-lg-8">
