...
<div class="row">
	<div class="col-lg-12">
		<h1 class="page-header">Insert Query</h1>
	</div>
...
?>
$result=mysqli_query($conn,"insert into <?php echo $tblnm;?>(<?php 	$fldarr=explode(",",$qry);
...
echo rtrim($fld1,',');
?> )values(<?php 	$fldarr3=explode(",",$qry);
foreach ($fldarr3 as $value3) {
$counter1++;

?>'$<?php echo  $fld3=strtolower(preg_replace('/[^a-zA-Z0-9-_\.]/','', $value3))."',";
if($counter1>=$arrsz-1){
break;
}
}
foreach ($fldarr3 as $value4) {
$fld4=strtolower(preg_replace('/[^a-zA-Z0-9-_\.]/','', $value4)).",";
}
?>'$<?php echo rtrim($fld4,',')."'";
?>
)");		
